...
public abstract class Pedido implements Despachable, Cancelable {
    ...
    // 1.3 Setter con visibilidad de paquete/protegida: la asignación depende
    // de la lógica propia de cada subclase o del hilo Repartidor que
    // procesa el pedido (ambos viven en el mismo paquete speedfastapp)
